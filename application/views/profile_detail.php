                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 wow fadeInUp">
                            <div class="de_tab tab_style_4 text-center">
                                <?php
                                $day1 = $this->db->query("select a.* from kg_calender a inner join kg_side_event b on b.id_calender=a.id WHERE b.id_member='".$val['id']."' AND a.is_delete=0 AND b.status='Approve' ORDER BY a.start_date asc");
                                $temp_tgl=0;
                                ?>
