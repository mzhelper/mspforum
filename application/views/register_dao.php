            ...
            <div id="top"></div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                        	<?php
                        	$typez_reg = GetValue("title","type_reg",array("id"=> "where/".$ses_mem['type_reg']));
                        	if($ses_mem['type_reg2']) $typez_reg .= " - ".GetValue("title","type_reg",array("id"=> "where/".$ses_mem['type_reg2']));
                        	?>
													<form action="<?php echo site_url('register/submit_dao');?>" method="post" enctype="multipart/form-data" id="registration-form" style="box-shadow:0px 0px 25px #ccc;padding:20px;">
														...
														<div class="row">
															...
															<p class="col-md-8">
																<select name="reg_type" class="reg_type" required>
																	...
																	<option value="3" <?php echo isset($ses_mem['zregz_type']) && $ses_mem['zregz_type']==3 ? "selected" : "";?>>Government</option>
																	<option value="4" <?php echo isset($ses_mem['zregz_type']) && $ses_mem['zregz_type']==4 ? "selected" : "";?>>Non-Government</option>
																</select>
															</p>
														</div>
														...
														<div class="row type_reg">
															...
															<p class="col-md-8">
																<select name="type_reg2" class="reg_type3" required>
																	<option value="12" <?php echo $ses_mem['type_reg2']==12 ? "selected" : "";?>>Participant</option>
																	<option value="10" <?php echo $ses_mem['type_reg2']==10 ? "selected" : "";?>>Speakers</option>
																	<option value="11" <?php echo $ses_mem['type_reg2']==11 ? "selected" : "";?>>Moderator</option>
																</select>
															</p>
														</div>
														<div class="row type_reg">
														...
														<div class="row">
															...
															<p class="col-md-8"><input name="firstname" type="text" placeholder="First Name" value="<?php echo $ses_mem['firstname'];?>" required></p>
														</div>
														<div class="row">
															<p class="col-md-4 lbl_text"><label class="col-md-12">Last/Family Name *</label></p>
															<p class="col-md-8"><input name="lastname" type="text" placeholder="Last/Family Name" value="<?php echo $ses_mem['lastname'];?>" required></p>
														</div>
														<div class="row">
														...
														<div class="row">
															...
															<p class="col-md-8"><input name="institusi" type="text" placeholder="Institution" value="<?php echo $ses_mem['institusi'];?>" required></p>
														</div>
														<div class="row">
															<p class="col-md-4 lbl_text"><label class="col-md-12">Position *</label></p>
															<p class="col-md-8"><input name="designation" type="text" placeholder="Position" value="<?php echo $ses_mem['designation'];?>" required></p>
														</div>														
														<div class="row">
														...
														<div class="row">
															...
															<p class="col-md-8">
																<input name="email" id="email" type="text" placeholder="E-Mail" value="<?php echo $ses_mem['email'];?>" required>
														...
														<div class="luarnegriz">
															...
															<div class="row">
																...
																<p class="col-md-8"><input name="passport" type="text" placeholder="Passport Number" value="<?php echo $ses_mem['passport'];?>" required></p>
															</div>
															<div class="row">
																<p class="col-md-4 lbl_text"><label class="col-md-12">Passport Expire Date *</label></p>
																<p class="col-md-1 col-xs-12">
																	<?php
																	$pe = explode("-",$ses_mem['passport_exp']);
																	$opt=array();
																	for($i=1;$i<=31;$i++) {
																		if($i < 10) $opt["0".$i] = "0".$i;
																		else $opt[$i] = $i;
															...
															<div class="row">
																...
																<p class="col-md-8">
																	...
																	echo form_dropdown("passport_place",$opt,$ses_mem['passport_place'],"class='negaraz' required");
																	?>
																</p>
															</div>
															<!--<div class="row">
														...
														<div class="row">
															<div class="col-md-12" style="text-align:center;">
																<p><button class="btn-large btn-style1 merah" name="btn_finish" value="1" type="submit" style="margin-right:0px;margin-top:20px;border:0px;width:150px;">SUBMIT</button> <span style='display: inline-block;margin-top: 40px !important;padding:0px 20px;'>OR</span>
																<button class="btn-large btn-style1 merah" name="btn_next" value="1" type="submit" style="margin-right:0px;margin-top:20px;border:0px;width:250px;">NEXT DELEGATE</button></p>
																<br><br>
															</div>
														</div>
