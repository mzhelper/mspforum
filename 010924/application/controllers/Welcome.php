...
class welcome extends CI_Controller {
	...
	function index()
  {
    ...
    $data['main'] = 'welcome';
    $data['filez'] = 'welcome';
    $data['functionz'] = 'welcome';
    $data['labelz'] = 'Welcome Message';
    ...
    $data['functionz'] = 'welcome';
    $data['labelz'] = 'Welcome Message';
    $this->load->view('welcome_new', $data);
	}
	
	function welcome_list($trash=0)
  {
	  ...
	  foreach ($list->result_array() as $r) {
		  ...
		  $check = "<a href='".site_url('welcome/welcome_detail/'.$r['id'])."'><i class='icon icon-pencil'></i></a>";
  ...
  function welcome_detail($id=0)
	{
		permission();
    $data = GetHeaderFooter();
    $data['main'] = 'welcome_detail';
    $data['filez'] = 'welcome';
    $data['functionz'] = 'welcome';
    $data['labelz'] = 'Welcome Message';
    $data['id'] = $id;
