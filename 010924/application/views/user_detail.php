				                            ...
				                            <div class="tab-pane fade active show" id="w2-tab1" role="tabpanel" aria-labelledby="w2-tab1">
				                                <div class="form-group form-float">
				                                	<div class="title-box">Personal Info</div>
								                            ...
								                            <?php
								                            $q = GetAll("type_reg",array("id_parents >"=> "where/0"));
								                            foreach($q->result_array() as $r) {
								                            	$opt_type[$r['id']]=$r['title'];
								                            }
								                            echo form_dropdown("type_reg",$opt_type,isset($val['type_reg']) ? $val['type_reg'] : 10,"class='form-control'");
								                            ?>
								                          </div>
								                        </div>
							                        	<div class="form-group form-float">
												...
												<!--<div class="form-group form-float">
													<div>
														...
														<?php if(isset($val['surat_tugas']) && $val['surat_tugas']){ ?>
															<a href="<?php echo 'https://mspforum.id/uploads/'.$val['surat_tugas'];?>">Download Surat Tugas</a><br>
														<?php } ?>
													</div>
												</div>-->
												<div class="form-group form-float">
													<div>
														<label class="form-label">DURATION OF STAY</label><br>
														<label class="form-label">Start</label>
														<div class="form-line">
															<input type="text" name="stay_start" class="form-control" value="<?php echo $val['stay_start'];?>">
														</div>
														<label class="form-label">End</label>
														<div class="form-line">
															<input type="text" name="stay_end" class="form-control" value="<?php echo $val['stay_end'];?>">
														</div>
													</div>
												</div>
