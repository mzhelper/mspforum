        	...
        	<div class="card-body p-0">
              <div class="card-box">
                	<form class="form-material" method="POST" action="<?php echo site_url($filez.'/'.$functionz.'_add');?>" enctype="multipart/form-data">
										...
										<input type="hidden" name="id_news_cat" value="3">
	                	<div class="row">
				                            ...
				                            <div class="tab-pane fade active show" id="w2-tab1" role="tabpanel" aria-labelledby="w2-tab1">
				                                <div class="form-group form-float">
							                        	...
							                        	<div class="form-group form-float">
							                              ...
							                              <label class="form-label">Jabatan di Keppres</label>
								                          </div>
								                        </div>
								                        <div class="form-group form-float">
							                            <div class="form-line">
							                              <input name="seo_title" class="form-control" value="<?php echo isset($val['seo_title']) ? $val['seo_title'] : "";?>">
							                              <label class="form-label">Jabatan Formal</label>
							                            </div>
							                        	</div>
								                        <!--<div class="form-group form-float">
								                          <div>
					            	...
					            	<div class="form-group form-float">
													<div>
														...
														<?php if(isset($val['image']) && $val['image']){ ?>
															<img src="<?php echo base_url('../uploads/'.$val['image']); ?>" style="height: 100px;"><br>
														<?php } ?>
												...
												<div class="form-group form-float">
													<div>
														...
														<?php if(isset($val['image_mobile']) && $val['image_mobile']){ ?>
															<img src="<?php echo base_url('../uploads/'.$val['image_mobile']); ?>" style="height: 100px;"><br>
														<?php } ?>
														<span class="badge badge-danger" style="margin-top: 10px;">*File harus berformat JPG, JPEG, atau PNG<span>
													</div>
												</div>
