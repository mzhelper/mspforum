    ...
    <div class="animated fadeInUpShort">
        <div class="card" style="background:white;">
        	...
        	<div class="card-body p-0 col-md-6">
        		<ul class="timeline">
            <?php
        		$q = GetAll("menu_bottom",array("id_parents"=> "where/0", "urutan"=> "order/asc"));
        		foreach($q->result_array() as $r) {?>
                 ...
                 <div class="timeline-item card">
                   <div>
                   	...
                   	<span class="float-right">
                   		<a href="<?php echo site_url('menuz/bottom_detail/'.$r['id']);?>"><i class='ion icon-pencil text-blue'></i></a>&nbsp;&nbsp;
                 ...
                 <?php
                 $qq = GetAll("menu_bottom",array("id_parents"=> "where/".$r['id'], "urutan"=> "order/asc"));
                 if($qq->num_rows() > 0) {
		               ...
		               <li>
		                 ...
		                 <div class="timeline-item card">
		                     <div>
		                     	<?php echo $rr['title'];?>
		                     	<span class="float-right">
			                   		<a href="<?php echo site_url('menuz/bottom_detail/'.$rr['id']);?>"><i class='ion icon-pencil text-blue'></i></a>&nbsp;&nbsp;
		                 ...
		                 <?php
		                 $qqq = GetAll("menu_bottom",array("id_parents"=> "where/".$rr['id'], "urutan"=> "order/asc"));
		                 if($qqq->num_rows() > 0) {
		                 	echo "<ul class='timeline timeline_sub'>";
...
<script>
	$(".pub").click(function(){
		...
		$.post("<?php echo site_url($filez.'/'.$functionz.'_aktif');?>", {idz:rel},  function(response) {
			window.location="<?php echo site_url($filez.'/bottom');?>";
		});
	});
